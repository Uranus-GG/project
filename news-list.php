...
$sql_news = "SELECT * FROM `news` WHERE news_ID $where order by news_ID DESC LIMIT $start_from,$per_page_record ";
    ...
    <br>  
         <nav aria-label="Page navigation example">
            ...
            <ul class="pagination pagination-lg justify-content-center">
               ...
               if ($page >= 2) {
                  echo "<li class='page-item'><a class='page-link' href='news-list.php?page=" . ($page - 1) . "'>Previous</a></li>";
               }

               for ($i = 1; $i <= $total_pages; $i++) {
                  if ($i == $page) {
                     $pagLink .= "<li class='page-item'><a class='page-link ' class = 'active' href='news-list.php?page="
                        . $i . "'>" . $i . " </a></li>";
                  } else {
                     $pagLink .= "<li class='page-item'><a class='page-link' href='news-list.php?page=" . $i . "'>   
                                                " . $i . " </a></li>";
                  }
               };
               echo $pagLink;
               ...
               if ($page < $total_pages) {
                  echo "<li class='page-item'><a class='page-link' href='news-list.php?page=" . ($page + 1) . "'>  Next </a></li>";
               }
